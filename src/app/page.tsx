  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header className="bg-green-900 shadow-sm w-full px-8 py-4 flex justify-between items-center">
        <div className="text-2xl font-bold text-white">waste.0</div>
        <SignedOut>
          <SignInButton>
      ...
      <section id="about" className="py-16 bg-gradient-to-r from-orange-200 via-yellow-100 to-green-200 text-center">
        <h2 className="text-3xl font-bold text-green-800">About waste.0</h2>
        <p className="mt-6 max-w-4xl mx-auto text-lg text-gray-700">
          waste.0 is dedicated to tackling the growing problem of food waste by connecting grocery stores with charities. By leveraging AI, our platform ensures grocery stores can optimize their daily orders to minimize excess and help charities receive food before it goes to waste.
        </p>
      </section>
      ...
      <footer id="contact" className="bg-green-900 text-white text-center py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="mt-4 text-gray-300">contact@waste0.com</p>
