  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header className="bg-white shadow-sm w-full px-8 py-4 flex justify-between items-center">
        <div className="text-2xl font-bold text-gray-800">wase.0</div>
        <SignedOut>
          <SignInButton>
      ...
      {/* Hero Section */}
      <section className="flex flex-col items-center justify-center flex-grow bg-gradient-to-r from-green-100 to-blue-100 text-center px-4 py-16">
        <h1 className="text-4xl sm:text-6xl font-extrabold text-gray-800">
          Reduce Food Waste with <span className="text-blue-600">wase.0</span>
        </h1>
      ...
      <section id="about" className="py-16 bg-white text-center">
        <h2 className="text-3xl font-bold text-gray-800">About wase.0</h2>
      ...
      <footer id="contact" className="bg-gray-800 text-white text-center py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="mt-4 text-gray-400">contact@wase0.com</p>
          <p className="mt-2 text-gray-400">123 Food Street, Save City, SC 12345</p>
        </div>
      </footer>
    </div>
  );
